...
import { handleGetScope, handleSaveScopedCanvasCourseIds } from "./api/scope";
...
ipcMain.handle("scope:get-scope", handleGetScope);
ipcMain.handle(
    "scope:save-scoped-canvas-course-ids",
    handleSaveScopedCanvasCourseIds,
);
